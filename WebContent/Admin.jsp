...
<body>
	<div id="header">
		...
		<a href="ViewOrdersAdmin"><button>View Orders</button></a>
		<a href="ViewSellerBuyer"><button>View Seller<br>Buyers</button></a>
		...
		<div>
			<ul>
				...
				<li><a href="AdminProductsList?param1=<%=uname%>">Products</a></li>
...
<div id="products">
<ul>
<li><a href="sellerupdate.jsp">Edit Profile</a></li>
<li><a href="Edit_delete_products">Edit Products</a></li>
